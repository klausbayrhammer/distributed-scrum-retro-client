...
describe('create card', function () {
    it('should trigger the undoPrepareCreateCard repository method when the undoPrepareCreateCard button is clicked', function () {
    ...
    it('should trigger the createCard repository method when the createCard button is clicked', function () {
